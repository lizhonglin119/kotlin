...
public class AnnotationChecker(private val additionalCheckers: Iterable<AdditionalAnnotationChecker>) {
    ...
    public fun check(annotated: JetAnnotated, trace: BindingTrace, descriptor: MemberDescriptor? = null) {
    ...
    companion object {
        ...
        private fun getActualTargetList(annotated: JetElement, descriptor: MemberDescriptor?): TargetList {
