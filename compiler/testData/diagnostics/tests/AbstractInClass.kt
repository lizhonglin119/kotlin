...
class MyClass() {
    ...
    <!ABSTRACT_PROPERTY_IN_NON_ABSTRACT_CLASS!>abstract<!> var b2: Int      <!ACCESSOR_VISIBILITY_FOR_PUBLIC_ABSTRACT_VAR!>private<!> set
    <!ABSTRACT_PROPERTY_IN_NON_ABSTRACT_CLASS!>abstract<!> var b3: Int = 0; <!ACCESSOR_VISIBILITY_FOR_PUBLIC_ABSTRACT_VAR!>private<!> set
