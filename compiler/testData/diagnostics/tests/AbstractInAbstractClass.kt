...
abstract class MyAbstractClass() {
    ...
    abstract var b2: Int      <!ACCESSOR_VISIBILITY_FOR_PUBLIC_ABSTRACT_VAR!>private<!> set
    abstract var b3: Int = <!ABSTRACT_PROPERTY_WITH_INITIALIZER!>0<!>; <!ACCESSOR_VISIBILITY_FOR_PUBLIC_ABSTRACT_VAR!>private<!> set
