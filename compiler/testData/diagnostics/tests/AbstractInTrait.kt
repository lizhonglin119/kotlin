...
interface MyTrait {
    ...
    var b: Int                                                                                          <!ACCESSOR_VISIBILITY_FOR_PUBLIC_ABSTRACT_VAR!>private<!> set
    var b1: Int = <!PROPERTY_INITIALIZER_IN_TRAIT!>0<!>;                                                private set
    <!ABSTRACT_MODIFIER_IN_TRAIT!>abstract<!> var b2: Int                                               <!ACCESSOR_VISIBILITY_FOR_PUBLIC_ABSTRACT_VAR!>private<!> set
    <!ABSTRACT_MODIFIER_IN_TRAIT!>abstract<!> var b3: Int = <!ABSTRACT_PROPERTY_WITH_INITIALIZER!>0<!>; <!ACCESSOR_VISIBILITY_FOR_PUBLIC_ABSTRACT_VAR!>private<!> set
