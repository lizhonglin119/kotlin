...
val i2 = <!CLASS_LITERAL_LHS_NOT_A_CLASS!><!GENERICS_IN_TYPE_NOT_ALLOWED!>A<*>.Inner<*><!>::class<!>
val i3 = <!CLASS_LITERAL_LHS_NOT_A_CLASS!><!GENERICS_IN_TYPE_NOT_ALLOWED!>A<Int>.Inner<CharSequence><!>::class<!>
